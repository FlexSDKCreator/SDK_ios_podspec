...
Pod::Spec.new do |spec|
  ...
  # spec.resource  = ""
   spec.resources =  "FlexSDK/**/*.{png,jpeg,jpg,storyboard,xib,xcassets}"
   spec.resource_bundles = { 'FlexSDKResource' => ['FlexSDK/**/*.{png,jpeg,jpg,storyboard,xib,xcassets}'] }
  ...
  spec.xcconfig = { 'SWIFT_VERSION' => '5.1', "HEADER_SEARCH_PATHS" => "$(SDKROOT)/usr/include/libxml2" }
